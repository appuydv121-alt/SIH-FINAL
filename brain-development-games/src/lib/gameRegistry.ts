...
export const GAME_REGISTRY: GameMetadata[] = [
  ...
  },
  {
    id: 'delayed-recall',
    name: 'Delayed Recall',
    description: 'Study a short list of items, complete a brief distraction task, then recall as many items as you can. One of the most sensitive tests for early memory changes.',
    category: 'memory',
    maxLevel: 10
  }
]
