...
export const GAME_INSTRUCTIONS: Record<string, GameInstructions> = {
  ...
  'delayed-recall': {
    ...
    instructions: [
      ...
      'After the list disappears, you\'ll do a short, simple counting task — this is normal and just a brief pause',
      'Once the counting task ends, type or select every original word you can remember',
