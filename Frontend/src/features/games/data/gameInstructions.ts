...
export const GAME_INSTRUCTIONS: Record<string, GameInstructions> = {
  ...
  "tower-of-hanoi": {
    ...
    instructions: [
      ...
      "The optimal solution requires 2ⁿ − 1 moves (where n is the number of disks)",
    ],
    tips: [
  ...
  "n-back": {
    title: "N-Back",
    instructions: [
      "Watch the sequence of letters appearing on screen",
  ...
  "delayed-recall": {
    ...
    instructions: [
      "You will briefly see a short list of words",
      "Try to remember as many of them as you can",
      "After the list disappears, you'll do a short counting task — this is normal",
      "Once the counting task ends, type every original word you can remember",
      "Order does not matter — just recall as many as possible",
      "Your score is based on how many original items you correctly recall",
    ],
    tips: [
      "Try picturing each item, or making a short story linking them together",
      "Repeating the words quietly to yourself while they're shown can help",
      "It's completely normal to not remember every item — do your best",
      "Take your time on the recall step; there is no rush",
    ],
  },
};
